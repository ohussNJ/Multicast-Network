...
class Router:
    ...
    def __init__(self, nodeid, ip, port):
        ...
        self.ip = ip
        self.port = port
        self.rt = {'neighbors': [{'id':201, 'ip':'192.168.1.2','gateway':'10.0.3.1','port':8881}, {'id':204, 'ip': '192.168.1.5', 'gateway':'10.0.3.2', 'port':8884}, {'id':205, 'ip': '192.168.5.3', 'gateway':'10.0.3.3', 'port':8885}],
    ...
    def receive(self):
        ...
        while 1:
            ...
            if pkttype == 3:
                ...
                print("Receive: "+ str(kval) +  "," + str(remk))
                if kval == 1 or remk == 1:
