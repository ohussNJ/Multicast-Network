...
class Router:
    ...
    def __init__(self, nodeid, ip, port):
        ...
        self.ip = ip
        self.port = port
        self.rt = {'neighbors': [{'id':101, 'ip':'192.168.1.1','gateway':'192.168.1.3','port':8880}, {'id':202, 'ip': '192.168.2.3', 'gateway':'10.0.1.0', 'port':8882},
    ...
    def heuristicMulticast(self, pkt, source, k, remk):
        ...
        if len(reachable) == 1:
            ...
            print(str(maxNode))
            print("remk=" + str(remk))
            print(reachable[indices.index(maxNode)])
